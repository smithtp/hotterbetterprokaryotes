...
for i in Datasets.keys(): #Iterate through the dictionary by key
    ...
    if models: #Check something has actually fitted
        ...
        print(best_model)
        best_model.plot('../Demo/Results', convert_kelvin = True, show_estimates=False) # want to see the fits in celsius, though currently incompatible with plotting uncertainty - TS
...
output_data.to_csv('../Demo/Results/summary.csv')
